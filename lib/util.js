...
exports.getVersionByte = function (addr) {
    var versionByte = bs58check.decode(addr).slice(0, 1);
    return versionByte;
};
...
exports.addressToScript = function (network, addr) {
    if (typeof network !== 'undefined' && network !== null) {
        console.log('network: ' + network + ', addr: ' + addr + ', script: ' + bitcoin.address.toOutputScript(addr, network));
...
exports.kotoAddressToScript = function (network, addr) {
    try {
