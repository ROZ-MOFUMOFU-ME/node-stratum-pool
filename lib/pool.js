...
import { Server as stratum } from './stratum.js';
...
const pool = function pool(options, authorizeFn) {
    ...
    function GetBlockTemplateParameters() {
        if (options.coin.passAlgorithm) {
            return [
                ...
                options.coin.passAlgorithm === true ? options.coin.algorithm : options.coin.passAlgorithm,
            ];
            ...
            return [
                {
                    ...
                    rules: ['segwit'],
                    algo:
                        options.coin.passAlgorithmKey === true ? options.coin.algorithm : options.coin.passAlgorithmKey,
                },
            ];
        }
    ...
    function SetupPeer() {
        ...
        _this.peer
            ...
            .on('connectionFailed', function (_e) {
                emitErrorLog('p2p connection failed - likely incorrect host or port');
            })
            .on('socketError', function (_e) {
                emitErrorLog(`p2p had a socket error ${JSON.stringify(_e)}`);
            })
                    ...
                    (options.coin.getInfo
                        ...
                        : typeof rpcResults.getmininginfo[multiAlgoDifficultyKey] !== 'undefined'
                            ...
                            : typeof rpcResults.getmininginfo.difficulty == 'object'
                                ...
                                : rpcResults.getmininginfo.difficulty) * algos[options.coin.algorithm].multiplier,
                        ...
                        options.coin.getAllNetworkHashPS
                            ? rpcResults.getallnetworkhashps[
                                options.coin.passAlgorithmKey
                                    ...
                                    : options.coin.passAlgorithm && options.coin.passAlgorithm !== true
