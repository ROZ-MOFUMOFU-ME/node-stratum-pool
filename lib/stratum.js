...
const NiceHashAPI = function () {
    ...
    this.refresh = function () {
        return new Promise(function (resolve, reject) {
            https
                .get(_this.url, _this.options, function (result) {
                    let error;
...
const niceHashAPIHandler = new NiceHashAPI();
                    ...
                    for (let i = 0; i < passwordArgs.length; i++) {
                        ...
                        case 'd':
                            _this.initialDifficulty =
                                    parseInt(passwordArgs[i].substr(passwordArgs[i].indexOf('=') + 1)) || -1;
                            break;
                        case 'md':
                            if (!_this.varDiff) {
